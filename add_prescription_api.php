...
if(
    ...
    try {
        ...
        if ($checkCustomer->rowCount() > 0) {
            ...
            $insertCustomer = $conn->prepare("INSERT INTO customers (first_name, last_name, email, phone) VALUES (:first_name, :last_name, :email, :phone) RETURNING id");
            ...
            $customer_id = $insertCustomer->fetchColumn();
        }
